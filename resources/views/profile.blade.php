...
<body>
    <div class="container my-5">
        <div class="row">
            <div class="col-12 my-3 p-4 shadow-sm rounded d-flex align-items-start bg-light">
                <img src="{{ $user->image->url }}" class="rounded-circle me-3" alt="{{ $user->name }}" style="width: 100px; height: 100px;">
                <div>
                    <h1>{{ $user->name }}</h1>
                    <h3>{{ $user->email }}</h3>
                    <p>
